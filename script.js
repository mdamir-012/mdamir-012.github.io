function sendMail(params) {
  ...
  GitHubCalendar(".calendar", "MdAmir", { responsive: true });
  ...
  resumeLink.addEventListener("click", function (event) {
    ...
    window.open(
      "https://drive.google.com/file/d/1lPNLV_5C_YeUpXnL-Avjawl0bBYhXJSS/view?usp=share_link",
      "_blank"
    );
    let link = document.createElement("a");
    link.href =
      "https://drive.google.com/uc?export=download&id=1lPNLV_5C_YeUpXnL-Avjawl0bBYhXJSS";
    link.download = "MD-AMIR-RESUME";
    link.click();
  });
